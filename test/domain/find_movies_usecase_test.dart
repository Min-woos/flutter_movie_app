import 'package:movie_app/data/data_resources/movie_data_source_impl.dart';
import 'package:movie_app/domain/repositories/movie_repository_impl.dart';
...
void main() {
  test('find movies usecase test', () async {
    ...
    // 레포지토리 -> usecase
    final findMoviesUsecase = FindMoviesUsecase(movieRepository);
    // usecase의 excute 함수 실행
    final result = await findMoviesUsecase.excuteNowPlaying();
